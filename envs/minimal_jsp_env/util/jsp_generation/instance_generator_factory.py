...
from envs.minimal_jsp_env.util.jsp_generation.multiple_instance_generator import MultipleInstanceGenerator, RepeatingMultipleInstanceGenerator, DeterministicMultiInstanceGenerator
...
jsp_generators.register_builder('repeating_multiple', RepeatingMultipleInstanceGenerator)
